...
<span style="background-color:#fefe99; padding:2px 6px;">Actores o entidades</span>  
personas o cosas que parecen tener algún papel central en el sistema. Son los que hacen las acciones.

<span style="background-color:#80eafe; padding:2px 6px;">Datos o atributos</span>  
información que describe las características de cada una de las cosas marcadas antes.

<span style="background-color:#51febc; padding:2px 6px;">Acciones</span>  
cosas que alguien o algo hace (verbos).

<span style="background-color:#ff4f5e; padding:2px 6px;">Reglas</span>  
condiciones que determinan cuándo algo puede o no ocurrir.

<span style="background-color:#ffcae5; padding:2px 6px;">Información dudosa</span>  
